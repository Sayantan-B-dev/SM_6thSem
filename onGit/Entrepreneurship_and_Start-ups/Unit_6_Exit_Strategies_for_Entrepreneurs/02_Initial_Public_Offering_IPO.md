...
```mermaid
graph TD
A[Company Decides to Go Public] --> B[Appoint Merchant Bankers & Advisors]
B --> C[Prepare & File DRHP with SEBI]
C --> D[Roadshows & Marketing]
D --> E[IPO Opens for Subscription]
E --> F[Bidding & Price Discovery]
F --> G[Allotment of Shares]
G --> H[Refund to Non-allottees]
G --> I[Credit Shares to Demat]
I --> J[Stock Lists on Exchange]
J --> K[Trading Begins]
```
