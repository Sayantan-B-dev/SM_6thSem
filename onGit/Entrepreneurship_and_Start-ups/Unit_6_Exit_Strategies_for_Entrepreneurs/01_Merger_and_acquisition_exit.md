...
```mermaid
graph TD
A[Start-up Prepares for Exit] --> B[Identify Potential Buyers]
B --> C[Initial Offer Received]
C --> D[Due Diligence by Acquirer]
D --> E[Negotiate Price & Terms]
E --> F[Sign Legal Agreements]
F --> G[Funds Transferred / Shares Issued]
G --> H[Founders & Investors Exit / Earn-Out]
```
