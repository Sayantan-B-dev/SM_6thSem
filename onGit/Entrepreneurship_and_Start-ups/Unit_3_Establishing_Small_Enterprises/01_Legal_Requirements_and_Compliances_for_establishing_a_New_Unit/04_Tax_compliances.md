...
```mermaid
graph TD
A[Start Business Operations] --> B[Obtain PAN, TAN, GST Registration]
B --> C[Issue Tax Invoice to Customers]
C --> D[Collect GST from Customers]
D --> E[Pay GST to Suppliers & Claim ITC]
E --> F[Calculate Net Tax Payable]
F --> G[Pay Tax to Government Online]
G --> H[File GST & Income Tax Returns]
H --> I[Maintain Records for Audit]
I --> J[End of Compliance Cycle]
```
