...
```mermaid
graph TD
A[Research Investor] --> B[Craft Core Story]
B --> C[Build Pitch Deck]
C --> D[Rehearse & Refine]
D --> E[Deliver Pitch]
E --> F{Was the Pitch Engaging?}
F -->|Yes| G[Handle Q&A]
F -->|No| H[Revise and Try Again]
G --> I[State Ask & Next Steps]
I --> J[Follow Up Within 24 Hours]
```
