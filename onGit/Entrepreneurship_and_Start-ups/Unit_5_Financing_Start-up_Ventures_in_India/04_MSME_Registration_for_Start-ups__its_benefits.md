...
```mermaid
graph TD
A[Start-up Owner] --> B[Visit Udyam Registration Portal]
B --> C[Enter Aadhaar and PAN]
C --> D[Fill Business Details]
D --> E[Declare Investment & Turnover]
E --> F[System Classifies as Micro/Small/Medium]
F --> G[Submit Application]
G --> H[Receive Udyam Certificate]
H --> I[Access Benefits: Loans, Subsidies, Tenders]
```
