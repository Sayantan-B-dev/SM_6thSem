...
```mermaid
graph TD
A[Raw Business Idea] --> B{Clear Customer Value?}
B -->|Yes| C{Market Demand & Size?}
B -->|No| Z[Reject Idea]
C -->|Yes| D{Profitable Unit Economics?}
C -->|No| Z
D -->|Yes| E{Scalable & Feasible?}
D -->|No| Z
E -->|Yes| F{Unique/Competitive Edge?}
E -->|No| Z
F -->|Yes| G[Promising Business Idea]
G --> H[Proceed to Planning & Prototype]
```
