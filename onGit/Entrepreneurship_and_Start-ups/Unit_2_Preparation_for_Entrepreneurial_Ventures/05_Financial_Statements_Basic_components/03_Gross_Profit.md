...
```mermaid
graph TD
A[Total Revenue / Net Sales] --> B[Cost of Goods Sold]
B --> C[Raw Material, Direct Labour, Direct Expenses]
A --> D[Subtract COGS]
D --> E[Gross Profit]
E --> F[Cover Operating, Selling, and Financial Expenses]
F --> G[Net Profit before Tax]
```
