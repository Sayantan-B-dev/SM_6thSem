...
B --> C[Market Feasibility]
B --> D[Technical Feasibility]
B --> E[Financial Feasibility]
B --> F[Legal Feasibility]
C --> G[Feasibility Report]
D --> G
E --> G
F --> G
G --> H{Feasible?}
H -->|Yes| I[Proceed to Business Plan]
H -->|No| J[Modify or Abandon Idea]
```
