...
```mermaid
graph TD
A[Market & Tech Info] --> B[Compute Total Project Cost]
B --> C[Decide Means of Finance]
C --> D[Prepare Financial Projections]
D --> E[Compile Annexures]
E --> F[Final Project Report]
F --> G[Submit to Bank/Govt Agency]
G --> H[Project Appraisal & Sanction]
```
