...
```mermaid
graph TD
A[Partners Agree on Business Idea] --> B[Draft & Sign Partnership Deed]
B --> C[Contribute Capital & Resources]
C --> D[Commence Business Operations]
D --> E[Manage Business Jointly]
E --> F[Share Profits / Losses]
E --> G[Mutual Agency: Partners Bind Firm]
F --> H[Reinvest or Distribute]
G --> I[Liabilities & Obligations]
```
