...
```mermaid
graph TD
    A[Mindset Spectrum] --> B[Employee Mindset]
    A --> C[Manager Mindset]
    A --> D[Entrepreneur Mindset]
    B --> B1[Seeks Security<br>Follows Instructions<br>Avoids Risk]
    C --> C1[Builds Systems<br>Manages People<br>Seeks Efficiency]
    D --> D1[Creates Opportunity<br>Takes Calculated Risk<br>Drives Vision]
    B1 --> E[Role: To Execute]
    C1 --> F[Role: To Optimize]
    D1 --> G[Role: To Create]
```
