...
```mermaid
graph TD
A[Financial Ratio Analysis of a Project] --> B[Liquidity Ratios]
A --> C[Activity Ratios]
A --> D[Leverage Ratio]
A --> E[Profitability Ratios]
B --> F[Current Ratio, Quick Ratio]
C --> G[Inventory Turnover, Asset Turnover]
D --> H[Debt-Equity Ratio]
E --> I[Net Profit Margin, ROA, ROE]
```
