...
```mermaid
graph TD
A[Total Project Cost] --> B[Fixed Capital]
A --> C[Working Capital]
B --> D[Long-term Assets]
C --> E[Current Assets minus Current Liabilities]
A --> F[Sources of Finance]
F --> G[Equity Shares/Owned]
F --> H[Debt: Loans, Debentures]
G --> I[Permanent, no fixed charge]
H --> J[Fixed interest, repayment obligation]
I --> K[Financial Health depends on right mix]
J --> K
```
