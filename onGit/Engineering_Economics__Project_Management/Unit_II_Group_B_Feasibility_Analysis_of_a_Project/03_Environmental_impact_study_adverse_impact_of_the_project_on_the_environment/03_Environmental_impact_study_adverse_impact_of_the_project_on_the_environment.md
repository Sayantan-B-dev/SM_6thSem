...
```mermaid
graph TD
A[Proposed Project] --> B[Screening & Scoping]
B --> C[Baseline Environmental Data Collection]
C --> D[Prediction of Adverse Impacts]
D --> E[Assessment of Severity]
E --> F[Planning Mitigation Measures]
F --> G[Preparation of EIS Report]
G --> H[Public Hearing & Review]
H --> I[Decision: Approval with Conditions or Rejection]
```
