...
```mermaid
graph TD
A[Economic System] --> B[Capitalist Economy]
A --> C[Socialist Economy]
A --> D[Mixed Economy]
B --> E[Government Role: Minimal - Regulator & Protector]
C --> F[Government Role: Total - Owner, Planner & Distributor]
D --> G[Government Role: Balanced - Regulator, Producer & Welfare Provider]
```
