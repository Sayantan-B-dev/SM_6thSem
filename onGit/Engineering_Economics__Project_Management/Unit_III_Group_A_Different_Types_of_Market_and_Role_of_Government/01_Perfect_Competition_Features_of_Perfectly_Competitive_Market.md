...
```mermaid
graph TD
A[Market Demand and Supply] --> B[Market Equilibrium Price P*]
B --> C[Individual Firm's Horizontal Demand Curve at P*]
C --> D[Firm Sets MC = MR = P* to Maximize Profit]
D --> E{Price > ATC?}
E -->|Yes, Supernormal Profit| F[New Firms Enter]
F --> G[Market Supply Increases, Price Falls]
G --> E
E -->|No, Price < ATC: Losses| H[Firms Exit]
H --> I[Market Supply Decreases, Price Rises]
I --> E
E -->|Price = Min ATC| J[Long-Run Equilibrium: Zero Economic Profit]
```
