...
C --> E[Monopolistic Competition: Many Sellers, Differentiated]
C --> F[Oligopoly: Few Sellers, Interdependent]
D --> G[Barriers, Price Maker, MR=MC]
E --> H[Free Entry, Tangency Solution, Normal Profit in LR]
F --> I[Strategic Interaction, Price Rigidity, Cartels]
```
