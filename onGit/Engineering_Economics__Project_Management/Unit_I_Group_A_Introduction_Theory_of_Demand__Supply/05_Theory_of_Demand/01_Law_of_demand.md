...
```mermaid
graph TD
A[Price Falls] --> B[Real Income Rises]
A --> C[Good Becomes Cheaper vs Substitutes]
B --> D[Consumer Buys More]
C --> D
D --> E[Quantity Demanded Increases]
F[Price Rises] --> G[Real Income Falls]
F --> H[Good Becomes Costlier vs Substitutes]
G --> I[Consumer Buys Less]
H --> I
