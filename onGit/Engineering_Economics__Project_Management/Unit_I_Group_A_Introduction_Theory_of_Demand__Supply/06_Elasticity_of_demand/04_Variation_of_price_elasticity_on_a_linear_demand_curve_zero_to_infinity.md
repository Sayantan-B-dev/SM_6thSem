...
```mermaid
graph TD
A[Vertical Intercept: P = a/b, Q = 0] --> B[Elasticity = Infinity]
B --> C[Upper Half of Demand Curve]
C --> D[Elasticity > 1, Demand is Elastic]
D --> E[Midpoint: P = a/2b, Q = a/2]
E --> F[Elasticity = 1, Unit Elastic]
F --> G[Lower Half of Demand Curve]
G --> H[Elasticity < 1, Demand is Inelastic]
H --> I[Horizontal Intercept: P = 0, Q = a]
I --> J[Elasticity = 0]
```
