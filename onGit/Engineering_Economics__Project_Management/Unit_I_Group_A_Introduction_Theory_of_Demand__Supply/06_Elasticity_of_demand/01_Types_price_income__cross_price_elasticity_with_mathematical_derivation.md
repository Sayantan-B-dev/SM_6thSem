...
```mermaid
graph TD
A[Elasticity of Demand] --> B[Price Elasticity Ed]
A --> C[Income Elasticity Ey]
A --> D[Cross-Price Elasticity Ec]
B --> E[Own Price Change]
C --> F[Consumer Income Change]
D --> G[Price Change of Related Good]
```
