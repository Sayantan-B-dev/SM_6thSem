...
```mermaid
graph TD
A[Price Change] --> B{Size of Change?}
B -->|Very Small| C[Use Point Elasticity]
B -->|Large / Discrete| D[Use Arc Elasticity]
C --> E[Elasticity = dQ/dP * P/Q]
D --> F[Elasticity = ΔQ/Avg Q ÷ ΔP/Avg P]
```
