...
```mermaid
graph TD
A[Initial Equilibrium Pe, Qe] --> B[External Shock Disturbs Price]
B --> C[Price Above Pe: Excess Supply]
B --> D[Price Below Pe: Excess Demand]
C --> E[Sellers Reduce Price]
D --> F[Buyers Bid Up Price]
E --> G[Price Moves Down towards Pe]
F --> H[Price Moves Up towards Pe]
G --> I[Equilibrium Restored at Pe]
H --> I
```
