...
```mermaid
graph TD
A[Initial Market Price] --> B{Compare Qd and Qs}
B -->|Qs > Qd: Surplus| C[Price Falls]
B -->|Qd > Qs: Shortage| D[Price Rises]
C --> E[Demand Increases, Supply Decreases]
D --> F[Demand Decreases, Supply Increases]
E --> B
F --> B
B -->|Qd = Qs| G[Equilibrium Price and Quantity Achieved]
```
