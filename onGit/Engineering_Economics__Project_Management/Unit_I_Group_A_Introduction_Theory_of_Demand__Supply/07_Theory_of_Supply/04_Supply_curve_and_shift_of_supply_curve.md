...
```mermaid
graph TD
A[Change Affecting Producer] --> B{Cause of Change?}
B -->|Own Price of Good Changed| C[Movement Along Supply Curve]
B -->|Other Factor Changed| D[Shift of Supply Curve]
D --> E{Factor Effect}
E -->|Cost Down / Tech Up / More Firms| F[Rightward Shift - Increase in Supply]
E -->|Cost Up / Tech Down / Fewer Firms| G[Leftward Shift - Decrease in Supply]
C --> H[Extension or Contraction of Supply]
```
