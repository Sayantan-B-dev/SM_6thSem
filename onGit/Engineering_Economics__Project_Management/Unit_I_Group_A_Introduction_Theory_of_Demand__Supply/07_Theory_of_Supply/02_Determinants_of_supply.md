...
```mermaid
graph TD
A[Improvement in Technology] --> B[Lower Production Cost]
B --> C[Higher Profit at Existing Price]
C --> D[Firms Produce More]
D --> E[Supply Curve Shifts Right]
E --> F[Market Quantity Supplied Increases]
```
